...
<div class="container">
  ...
  <?php if ($docVenta['Nombre']!=''): ?>
    <div>RUTA: <?php echo $docVenta['Nombre']; ?></div>
    <div>ORIGEN: <?php echo $docVenta['CiudadOrigen']; ?></div>
    <div>DESTINO: <?php echo $docVenta['CiudadDestino']; ?></div>
    <div>F. VIAJE: <?php echo $docVenta['FechaViaje']; ?></div>
    <div>H. VIAJE: <?php echo $docVenta['HoraViajeFormat']; ?></div>
    <div>ASIENTO: <?php echo $docVenta['IdAsiento']; ?></div>
  <?php endif; ?>
          ...
          <?php if (empty($producto['EsManoDeObra'])) : ?>
            ...
            <td class="Numero">
              ...
              <td class="text-right">
                ...
                ?>
                <span  style="font-size11px" ><?php echo $producto['TOTAL']; ?></span>
              </td>
            </tr>
            <?php
            $filas += 1;
