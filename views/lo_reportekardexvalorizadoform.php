...
$(document).ready(function(e){
	...
	$("#btnReportar").click(function(e){		
		window.location = "reporteExcel4.php?producto="+$("#txtProducto").val()+"&fechaIni="+$("#txtFechaIni").val()+"&fechaFin="+$("#txtFechaFin").val();
	});
  ...
  $("#btnGenerar").click(function(){
    ...
    var xhr = $.ajax({
      ...
      type: "get",
      data: {producto: $("#txtProducto").val(), fechaIni: $("#txtFechaIni").val(), fechaFin: $("#txtFechaFin").val()},
      dataType: "html",
...
<div class="bt-panel">
	<div class="container center_div" >
 	<button id="btnReportar" class="btn btn-success fab" data-toggle="modal" data-target="#nuevo"><i class="fa fa-file-excel-o"></i></button>
      ...
      <div class="row">
        ...
        <input type="number" class="form-control" id=="txtAnno" placeholder="A &ntilde;o">
      </div>
		<div class="row">
    ...
    <div class="row">
      ...
      <input type="number" class="form-control" placeholder="Stock " id="txtStockIni">
    </div>
    <div class="row">
      <label>Costo</label>
      <input type="number" class="form-control" placeholder="Costo " id="txtCosto">
    </div>
    <div class="row">
      <div class="col-md-4">
