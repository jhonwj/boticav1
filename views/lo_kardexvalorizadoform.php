...
$(document).ready(function(e){
	...
	$("#btnReportar").click(function(e){
		window.location = "reporteExcel4.php?producto="+$("#txtProducto").val()+"&anno="+$("#txtAnno").val()+"&stock="+$("#txtStockIni").val()+"&precio="+$("#txtCosto").val()+"&Tipo="+$("#Tipo").val();
	});
  ...
  $("#btnGenerar").click(function(){
    ...
    var xhr = $.ajax({
      url: "lo_listarstockvalorizado.php",
      type: "get",
      data: {producto: $("#txtProducto").val(), anno: $("#txtAnno").val(), stock: $("#txtStockIni").val(), precio: $("#txtCosto").val(), Tipo: $("#Tipo").val()},
      dataType: "html",
      success: function(res){
        ...
        $.each(respuesta, function(data, value){
          tablagenerado =tablagenerado  + "<tr><td>"+value.d1+"</td><td>"+value.d2+"</td><td>"+value.d3+"</td><td>"+ (isNaN(parseFloat(value.d4)) ? '' : parseFloat(value.d4).toFixed(2)) +"</td><td>"+ (isNaN(parseFloat(value.d5)) ? '' : parseFloat(value.d5).toFixed(2)) +"</td><td>"+value.d6+"</td><td>"+value.d7+"</td><td>"+value.d8+"</td><td>"+value.d9+"</td><td>"+value.d10+"</td><td>"+value.d11+"</td></tr>";
        });
...
<div class="bt-panel">
	<div class="container center_div" >
 	<button id="btnReportar" class="btn btn-success fab" data-toggle="modal" data-target="#nuevo"><i class="fa fa-file-excel-o"></i></button>
      ...
      <div class="row">
        <label>AÑO</label>
        <input type="number" value="<?php echo date("Y"); ?>" class="form-control" id="txtAnno" placeholder="Año">
      </div>
		<div class="row">
    ...
    <div class="row">
      <label class="">Stock Inicial</label>
      <input type="number" class="form-control" placeholder="Stock" value="0" id="txtStockIni">
    </div>
    <div class="row">
      <label>Costo</label>
      <input type="number" class="form-control" placeholder="Costo " value="0" id="txtCosto">
    </div>
    <div class="row">
      <div class="col-md-4">
		...
		<div class="panel panel-success">
			<div class="panel panel-heading">
				<div class="form-inline">
				<label class="">Stock Valorizado </label>
