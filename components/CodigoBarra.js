export default {
  template: `
    <div class="barcode-box">
      ...
      <div class="barcode-logo"><img src="/resources/images/barcode-logo.png"  style="height:6mm; margin: .5mm"/></div>
      ...
      <div class="barcode-left">
        <!--<div class="item negro">ART.</div>--><div class="item derecha">{{ producto.Producto.substring(0, 16).toUpperCase() }}</div><br />
        ...
        <div class="barcode-image">
            <barcode :value="producto.CodigoBarra" tag="svg" :options="{ width: .92, margin:5, height: 18, fontSize: 7, marginTop: 1, marginBottom: 1}" ></barcode>
        </div>
        <span></span>
    </div>
