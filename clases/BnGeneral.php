...
INNER JOIN botica.Gen_Producto ON Ve_DocVentaDet.IdProducto = Gen_Producto.IdProducto ";
   ...
   /* function fn_devolverPuntodeVenta($criterio, $orden){
	...
	function fn_devolverDiagnostico(){
		$Ssql = "SELECT IdDiagnostico, Diagnostico, Problema, Edad, Observacion, FechaReg, UsuarioReg, FechaMod, UsuarioMod FROM botica.Ve_ExpertoDiagnostico;";
		return getSQLResultSet($Ssql);
	}
	...
	{
		$Ssql = " SELECT * FROM botica.Seg_Usuario";
		return getSQLResultSet($Ssql);
	}

	function ListarPerfil()
	{
		$Ssql = " SELECT * FROM botica.Seg_UsuarioPerfil";
		return getSQLResultSet($Ssql);
	}
